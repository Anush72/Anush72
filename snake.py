...
class Snake:
    ...
    def create_snake(self):
        for starting_position in STARTING_POSITIONS:
           self.add_segement(starting_position)

    """Function called extend and add_segment to extend our snake"""
    ...
    def extend(self):
        """Holding last segment of snake """
        self.add_segement(self.segments[-1].position())

    def reset(self):
        """reset function to make snake again"""
